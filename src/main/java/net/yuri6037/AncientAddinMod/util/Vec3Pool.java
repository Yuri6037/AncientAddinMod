...
/**
 * Imported from Minecraft Forge client 1.6.4
 */
public class Vec3Pool
{
     ...
     */
    private Vec3 setComponents(Vec3 vec, double p_72439_1_, double p_72439_3_, double p_72439_5_)
    {
        vec.xCoord = p_72439_1_;
        vec.yCoord = p_72439_3_;
        vec.zCoord = p_72439_5_;
        return vec;
    }
    ...
    public Vec3 getVecFromPool(double par1, double par3, double par5)
    {
        ...
        else
        {
            ...
            {
                vec3 = Vec3.createVectorHelper(par1, par3, par5);
                this.vec3Cache.add(vec3);
            }
            else
            {
                vec3 = (Vec3)this.vec3Cache.get(this.nextFreeSpace);
                setComponents(vec3, par1, par3, par5);
            }
