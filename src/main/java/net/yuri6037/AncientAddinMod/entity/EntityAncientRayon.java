...
public class EntityAncientRayon extends Entity implements IThrowableEntity {
    ...
    public EntityAncientRayon(World par1World)
    {
        super(par1World);
    ...
    public EntityAncientRayon(World p_i1761_1_, EntityLivingBase p_i1761_2_, double p_i1761_3_, double p_i1761_5_, double p_i1761_7_)
    {
        super(p_i1761_1_);
    ...
    /**
     * Called when this EntityAncientRayon hits a block or entity.
     */
    protected void onImpact(MovingObjectPosition par1MovingObjectPosition)
    {
        if (!this.worldObj.isRemote)
        {
            ...
            List<Entity> l = EntityFinder.findEntitiesInRayon(EntityType.OBJECT, this, 5, false);
            for (Entity e : l){
